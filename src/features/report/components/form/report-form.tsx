...
export default function ReportForm({ reportId, onHandleDialog }: ReportFormProps) {
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        <Button onClick={() => onHandleDialog?.()} type="submit" className="w-full font-bold uppercase">
          {
