...
interface ReportRowDataInfiniteProps {
  userId?: string;
  isShowAction?: boolean;
}

export default function ReportRowDataInfinite({
  userId,
  isShowAction = true,
}: ReportRowDataInfiniteProps) {
  ...
  return allReports.length > 0 ? (
    <>
      ...
      {isFetchingNextPage && <ReportTableSkeleton />}

      <TableRow ref={ref}>
        <TableCell colSpan={6} className="h-4" />
      </TableRow>
